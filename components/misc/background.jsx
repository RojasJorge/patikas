...
export const BackgroundSite2 = () => {
  return (
    ...
    >
      <g>
      <linearGradient id="svg-gradient" x1="0" x2="1" y1="0" y2="0">
          {/* <stop stop-color="hsl(33, 33.3%, 233%)" offset="1"></stop>
          <stop stop-color="hsl(20, 54.5%, 80.2%)" offset="2"></stop> */}
          <stop stop-color="hsl(217, 88%, 33.7%)" offset="0"></stop>
          <stop stop-color="hsl(217, 88%, 75.1%)" offset="1"></stop>
        </linearGradient>
      </g>
      <path
        d="M82 556C156 601 432 637.408 519 604C644 556 780 469.401 812 435.001C850.14 394 832 116.5 691 61.5001C550 6.50015 208 -41.5 115 61.5001C-2.20846 191.312 -54 501 82 556Z"
        fill="#BEAB00"
      />
    </svg>
  );
